...
interface IIssuanceProps {
  land: TSafeLandElement | null;
}
const Issuance = ({ land }: IIssuanceProps) => {
  const subText =
    'Once issued, your Land Title Certificate will be uploaded here';

  const stage = EServiceOptions.ISSUANCE;
